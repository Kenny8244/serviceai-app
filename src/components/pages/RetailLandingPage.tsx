...
import { ShoppingBag, ArrowRight, CheckCircle, Users, TrendingUp } from "lucide-react"
import { AISearch } from "../ui/AISearch"
import { BackButton } from "../ui/BackButton"
import { AIAssistant } from "../ui/AIAssistant"

interface RetailLandingPageProps {
  onGetStarted: () => void
}

export function RetailLandingPage({ onGetStarted }: RetailLandingPageProps) {
        ...
        <div className="relative z-10 container mx-auto px-6 py-16 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-foreground mb-6 leading-tight text-balance">
              Welcome to
              <br />
              <span className="text-gradient">Retail AI</span>
            </h1>

            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed text-pretty mb-12">
              Transform your retail operations with AI-powered customer insights, inventory optimization,
              and intelligent automation designed specifically for modern retail businesses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <Card className="backdrop-blur-glass border-border/50 card-hover text-center">
              <CardHeader>
                ...
                <CardTitle className="text-xl">AI-Powered Retail Management</CardTitle>
                <CardDescription>
                  Complete service request workflows, intelligent inventory management, and comprehensive asset tracking
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="backdrop-blur-glass border-border/50 card-hover text-center">
              <CardHeader>
                ...
                <CardDescription>
                  AI-powered stock management to reduce waste and maximize profits
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-semibold text-foreground mb-3">
                🔍 Explore Retail AI Features
              </h3>
              <p className="text-muted-foreground">
                Search for specific AI tools and capabilities tailored for retail businesses
              </p>
            </div>
            <AISearch
              placeholder="Search retail features like 'customer analytics', 'inventory optimization', 'pricing strategies'..."
              className="mx-auto"
            />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-foreground">Increase sales by up to 35%</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-400" />
                  <span className="text-foreground">Reduce inventory costs by 25%</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-400" />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-400" />
                  <span className="text-foreground">Automated reporting</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-400" />
                  <span className="text-foreground">24/7 AI support</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            >
              {isLoading ? (
                ...
                <div className="flex items-center space-x-3">
                  <span>Get Started with Retail AI</span>
            ...
            <p className="text-muted-foreground mt-6 text-sm">
              Ready to revolutionize your retail business? Join the AI-powered retail revolution today.
            </p>
          </div>
        </div>
      </div>
